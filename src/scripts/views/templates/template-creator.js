...
const restoItemTemplate = (resto) => `
    <div class="list_item">
        <picture>
          <source type="image/webp" data-srcset="${resto.pictureId ? CONFIG.BASE_IMAGE_URL_SMALL + resto.pictureId : 'https://picsum.photos/id/666/800/450?grayscale'}" media="all and (max-width: 600px)">
          <source type="image/jpeg" data-srcset="${resto.pictureId ? CONFIG.BASE_IMAGE_URL_MEDIUM + resto.pictureId : 'https://picsum.photos/id/666/800/450?grayscale'}" media="all and (min-width: 601px)">
          <img class="lazyload list_item_img" data-src="${resto.pictureId ? CONFIG.BASE_IMAGE_URL_LARGE + resto.pictureId : 'https://picsum.photos/id/666/800/450?grayscale'}" alt="${resto.name}">
        </picture>
